...
Page({
  ...
  getGoods: function (cb) {
    ...
    // var newList = {
    //   "productId": 2,
    //   "title": "华硕(ASUS) 飞行堡垒6 15.6英寸窄边框游戏笔记本电脑(i5-8300H 8G 256GSSD+1T GTX1050Ti 4G IPS)火陨红黑",
    //   "price": '6096.00',
    //   "mainPicUrl": "http://mall-imgs.oss-cn-hangzhou.aliyuncs.com/product/pd_pic20645.jpg",
    //   "total": 1,
    //   "仓库": '香港',
    //   "logistic": {
    //     "顺风": '10.00',
